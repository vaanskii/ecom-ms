...
type ProductServiceClient interface {
	...
	GetAllProducts(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ProductListResponse, error)
}
...
func (c *productServiceClient) GetAllProducts(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ProductListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductServiceServer interface {
	...
	GetAllProducts(context.Context, *EmptyRequest) (*ProductListResponse, error)
...
func (UnimplementedProductServiceServer) GetAllProducts(context.Context, *EmptyRequest) (*ProductListResponse, error) {
